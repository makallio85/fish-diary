    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <?= $this->Html->link('', ['action' => 'edit', $fishType->id], ['title' => __('Edit'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                <?= $this->Form->postLink('', ['action' => 'delete', $fishType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $fishType->id), 'title' => __('Delete'), 'class' => 'btn btn-default glyphicon glyphicon-trash']) ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
