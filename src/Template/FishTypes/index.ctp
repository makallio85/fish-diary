...
<div class="fishTypes index large-9 medium-8 columns content">
    <h3><?= __('Fish Types') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $fishType->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $fishType->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $fishType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $fishType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
